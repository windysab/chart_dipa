...
LEFT JOIN (
    ...
    WHERE YEAR(tanggal_pendaftaran)='2024' AND MONTH(tanggal_pendaftaran)='01' AND  jenis_perkara_nama = 'Pdt.P'
    ...
    WHERE YEAR(tanggal_putusan)='2024' AND MONTH(tanggal_putusan)='01' AND  jenis_perkara_nama = 'Pdt.P'
    AND perkara_pihak1.`urutan`='1'
    GROUP BY KECAMATAN
