...
<head>
	...
	<title>Laporan Keuangan - April 2025</title>
	<style>
		:root {
	...
	<div class="content-wrapper">
		<div class="financial-report-container">
			...
			<div class="report-body">
				<div class="table-responsive">
					<table class="financial-table">
						...
						<tbody>
							...
							<!-- April section in the table -->
							<tr>
								<td rowspan="4"><?= $financial_data['months'][3] ?></td>
								<td class="category-cell"><?= array_keys($financial_data['categories'])[0] ?></td>
								<td><?= number_format($financial_data['categories']['Belanja Pegawai']['pagu'][3]) ?></td>
							...
							<tr>
								<td class="category-cell"><?= array_keys($financial_data['categories'])[1] ?></td>
								<td><?= number_format($financial_data['categories']['Belanja Barang']['pagu'][3]) ?></td>
								<td><?= number_format($financial_data['categories']['Belanja Barang']['realisasi'][3]) ?></td>
								<td class="percentage-cell"><?= $financial_data['categories']['Belanja Barang']['percentage'][3] ?> %</td>
								<td><?= number_format($financial_data['categories']['Belanja Barang']['sisa_pagu'][3]) ?></td>
								<td></td>
							</tr>
							<tr>
								<td class="category-cell"><?= array_keys($financial_data['categories'])[2] ?></td>
							...
							<tr class="total-row">
								<td class="category-cell">Total</td>
								<td><?= number_format($financial_data['totals']['pagu'][3]) ?></td>
								<td><?= number_format($financial_data['totals']['realisasi'][3]) ?></td>
								<td class="percentage-cell"><?= round(($financial_data['totals']['realisasi'][3]) / $financial_data['totals']['pagu'][3] * 100, 2) ?> %</td>
								<td><?= number_format($financial_data['totals']['sisa_pagu'][3]) ?></td>
								<td></td>
							</tr>
						</tbody>
					</table>
				...
				<p class="note">* Data realisasi anggaran sampai dengan bulan April 2025</p>
			</div>
		</div>
