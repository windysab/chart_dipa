-- Query sederhana dispensasi kawin dengan faktor penyebab default
-- Karena tabel perkara_dispensasi_kawin tidak ada, kita gunakan asumsi faktor utama "Menghindari Zina"
SELECT
    1 as NO,
