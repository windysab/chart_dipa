...
<head>
    ...
    <title><?= htmlspecialchars($title ?? 'Laporan Perkara LIPA – Maret 2026'); ?></title>
    ...
    <style>
        ...
        * {
        ...
        .metric-card {
            background: linear-gradient(135deg, var(--card-color), #f0fdf4);
            border: 0;
            border-radius: 20px;
            box-shadow: var(--shadow);
...
<body>
    <div class="container-xxl py-4">
        ...
        <div class="hero p-4 mb-4 d-flex justify-content-between align-items-center">
            <div>
                <h3 class="mb-1 fw-bold">LAPORAN PERKARA LIPA MARET</h3>
                <div class="opacity-75">Statistik Perkara Musim Semi 2026</div>
            </div>
            <div class="d-flex flex-column align-items-end">
                <span class="badge bg-light text-dark px-3 py-2 rounded-pill mb-2">Maret 2026</span>
                <span class="spring-indicator">🌱 Musim Semi</span>
            </div>
        </div>
            ...
            <div class="col-md-6">
                <div class="card section-card h-100">
                    <div class="card-body chart-box">
                        <h6 class="mb-3"><i class="fas fa-chart-pie"></i> Distribusi Perkara Maret</h6>
            ...
            <div class="col-12">
                <div class="catatan-card">
                    <h6 class="mb-3 text-center" style="color: var(--primary-color); font-weight: 700;">
                        <i class="fas fa-info-circle"></i> CATATAN PERKARA MARET 2026
                    </h6>
                    <div class="row">
                        <div class="col-md-6">
                            <p><strong>Catatan:</strong> Peningkatan efisiensi penyelesaian perkara di musim semi</p>
                            <p><strong>Total Perkara Jan-Mar:</strong> 295 perkara masuk, 175 perkara selesai</p>
                        </div>
                        <div class="col-md-6">
                            <p><strong>Efisiensi Penyelesaian:</strong> 57.3% (target minimal 40% tercapai)</p>
                            <p><strong>Sisa Akhir:</strong> 61 perkara yang perlu segera diselesaikan</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            new Chart(document.getElementById('pieDistribusi'), {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        backgroundColor: [
                            '#059669', '#10b981', '#a7f3d0', '#34d399', '#047857',
                            '#e91e63', '#06b6d4', '#84cc16', '#f43f5e', '#6366f1',
            ...
            function makeSeries(src, key) {
                ...
                const defaultData = {
                    'diterima': [111, 134, 50, 0, 0, 0, 0, 0, 0, 0, 0, 0],
                    'jumlah_laju_6_13': [25, 68, 82, 0, 0, 0, 0, 0, 0, 0, 0, 0],
                    'sisa_akhir': [91, 160, 61, 0, 0, 0, 0, 0, 0, 0, 0, 0]
                };
