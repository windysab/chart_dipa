-- Query dispensasi kawin per kecamatan sesuai format tabel yang diminta
-- Format: No, Kecamatan, Jumlah Perkara Diterima, Umur 18 s/d 19 Tahun, Umur Dibawah 18 Tahun, Jumlah dikabulkan
SELECT
    CASE
