...
<head>
    ...
    <title>Laporan Perkara LIPA Agustus 2025</title>
...
<div class="container">
    <div class="dashboard-header">
        <div class="dashboard-title">
            <h1>LAPORAN PERKARA LIPA Agustus</h1>
            <h2>Statistik Perkara Diterima, Dicabut, dan Diputus Menurut Jenis</h2>
        </div>
        <div class="dashboard-date">Agustus 2025</div>
    </div>
    ...
    <div class="card">
        <div class="card-header">
            <i class="fas fa-table"></i> Rincian Perkara Bulan Agustus 2025
        </div>
        <div class="card-body">
    ...
    <div class="chart-container" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(450px, 1fr)); gap: 30px; margin-bottom: 30px;">
        <div class="chart-card" style="background: linear-gradient(135deg, #fff, #f8fafc); border-radius: 20px; box-shadow: 0 15px 35px rgba(0,0,0,0.1); padding: 25px; border: 1px solid rgba(59, 130, 246, 0.1);">
            <div class="chart-title" style="font-size: 1.3rem; color: #1e3a8a; margin-bottom: 25px; padding-bottom: 15px; border-bottom: 2px solid #e2e8f0; font-weight: 700;"><i class="fas fa-chart-pie"></i> Distribusi Perkara Agustus</div>
