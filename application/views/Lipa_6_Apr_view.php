...
<head>
	...
	<style>
		...
		* {
		...
		/* Add these new styles to improve JUMLAH row visibility */
		.custom-table tfoot tr td {
			border: 1px solid #fff;
			font-size: 15px;
		}

		.custom-table tfoot .case-count {
			color: #ffffff;
			font-weight: 700;
			text-shadow: 1px 1px 1px rgba(0, 0, 0, 0.3);
		}

		.custom-table tfoot .highlight-cell {
				...
				<table class="custom-table">
					...
					<tfoot>
						<tr>
							...
							<td class="case-count highlight-cell">121</td>
							<td class="case-count">4</td>
							<td class="case-count">46</td>
							<td class="case-count">1</td>
							<td class="case-count">0</td>
							<td class="case-count">0</td>
							<td class="case-count">0</td>
							<td class="case-count">0</td>
							<td class="case-count">0</td>
							<td class="case-count highlight-cell">51</td>
							<td class="case-count">70</td>
							<td class="case-count">0</td>
							<td class="case-count">0</td>
							<td class="case-count">0</td>
							<td></td>
