...
<head>
    ...
    <title><?= htmlspecialchars($title ?? 'Laporan Perkara LIPA – Oktober 2025'); ?></title>
...
<body>
    <div class="container-xxl py-4">
        ...
        <div class="hero p-4 mb-4 d-flex justify-content-between align-items-center">
            <div>
                <h3 class="mb-1 fw-bold">LAPORAN PERKARA LIPA OKTOBER</h3>
                <div class="opacity-75">Statistik Perkara Oktober 2025</div>
            </div>
            ...
            <div class="col-md-6">
                <div class="card section-card h-100">
                    <div class="card-body chart-box">
                        <h6 class="mb-3"><i class="fas fa-chart-pie"></i> Distribusi Perkara Oktober</h6>
        ...
        <div class="card section-card mb-4">
            <div class="card-body">
                <h6 class="mb-3 text-center" style="color: var(--primary-color); font-weight: 700;">
                    <i class="fas fa-info-circle"></i> CATATAN PERKARA OKTOBER 2025
                </h6>
                <div class="alert alert-warning" role="alert">
                    <strong>Catatan:</strong> Isbat Nikah Kontensius sebanyak 5 perkara (575, 576, 579, 584, 596)
                </div>
            </div>
        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            new Chart(document.getElementById('pieDistribusi'), {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        backgroundColor: [
                            '#ea580c', '#f59e0b', '#d97706', '#10b981', '#8b5cf6',
                            '#fb923c', '#06b6d4', '#84cc16', '#f43f5e', '#6366f1',
            ...
            const bulanYTD = ['Januari', 'Februari', 'Maret', 'April', 'Mei', 'Juni', 'Juli', 'Agustus', 'September', 'Oktober'];
            ...
            function makeSeries(src, key) {
                ...
                // Default data with actual monthly progression from January to October
                const defaultData = {
                    'diterima': [89, 112, 95, 103, 128, 124, 143, 116, 107, 99, 0, 0],
                    'jumlah_laju_6_13': [94, 108, 87, 98, 135, 119, 151, 148, 108, 129, 0, 0],
                    'sisa_akhir': [95, 99, 107, 112, 105, 110, 102, 98, 97, 67, 0, 0]
                };
                return defaultData[key] || new Array(12).fill(0);
            }
            const seriMasuk = makeSeries(tMasuk, 'diterima').slice(0, 10);
            const seriSelesai = makeSeries(tSelesai, 'jumlah_laju_6_13').slice(0, 10);
            const seriSisa = makeSeries(tSisa, 'sisa_akhir').slice(0, 10);
