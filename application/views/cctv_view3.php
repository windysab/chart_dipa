...
<body>
	<div class="container">
		...
		<div class="row total-perkara-container text-center">
			...
			<div class="col-md-3 col-sm-6">
				...
				<p class="title">Perkara e-Court</p>
			</div>
			<div class="col-md-3 col-sm-6">
			...
			<div class="col-md-3 col-sm-6">
				...
				<p class="title">Perkara Non e-Court</p>
			</div>
		</div>
		<div class="row">
	...
	<script>
		$(function() {
				...
				plugins: {
					legend: {
						...
						labels: {
							font: {
								size: 14,
								color: '#800080' // Change label color to purple
							}
						}
					},
					tooltip: {
			...
			var efilingChart = new Chart(efilingChartCanvas, {
				type: 'bar',
				data: efilingData,
