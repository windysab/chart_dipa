...
<head>
	...
	<title><?= htmlspecialchars($title ?? 'Laporan Perkara LIPA – November 2025'); ?></title>
...
<body>
	<div class="container-xxl py-4">
		...
		<div class="hero p-4 mb-4 d-flex justify-content-between align-items-center">
			<div>
				<h3 class="mb-1 fw-bold">LAPORAN PERKARA LIPA NOVEMBER</h3>
				<div class="opacity-75">Statistik Perkara November 2025</div>
			</div>
		...
		<div class="row g-3 mb-4">
			<div class="col-md-6">
				<div class="card section-card h-100">
					<div class="card-body chart-box">
						<h6 class="mb-3"><i class="fas fa-chart-pie"></i> Distribusi Perkara November</h6>
			...
			<div class="col-md-6">
				<div class="card section-card h-100">
					<div class="card-body chart-box">
						<h6 class="mb-3"><i class="fas fa-chart-bar"></i> Tren Penyelesaian Perkara (YTD)</h6>
		...
		<div class="card section-card mb-5">
			<div class="card-body chart-box">
				<h6 class="mb-3"><i class="fas fa-chart-line"></i> Perbandingan Bulanan: Masuk vs Selesai vs Sisa</h6>
			...
			<div class="col-12">
				<div class="catatan-card">
					<h6 class="mb-3 text-center" style="color: var(--primary-color); font-weight: 700;">
						<i class="fas fa-info-circle"></i> CATATAN PERKARA NOVEMBER 2025
					</h6>
					<div class="row">
						<div class="col-md-6">
							<p><strong>Catatan:</strong> Isbat Nikah Kontensius sebanyak 5 perkara (527, 531, 650, 658, 670, 671, 572)</p>
						</div>
						<div class="col-md-6">
							<p><strong>Total Perkara Aktif:</strong> Dari 76 perkara yang diterima bulan ini, 91 perkara berhasil diselesaikan</p>
						</div>
					</div>
				</div>
			</div>
	...
	<script>
		document.addEventListener('DOMContentLoaded', function() {
			...
			// ===== BAR: Tren penyelesaian (YTD) – seri dari controller
			const bulanYTD = ['Januari', 'Februari', 'Maret', 'April', 'Mei', 'Juni', 'Juli', 'Agustus', 'September', 'Oktober', 'November'];
			...
			function makeSeries(src, key) {
				...
				// Default data with actual monthly progression from January to November
				const defaultData = {
					'diterima': [89, 112, 95, 103, 128, 124, 143, 116, 107, 99, 76, 0],
					'jumlah_laju_6_13': [94, 108, 87, 98, 135, 119, 151, 148, 108, 129, 91, 0],
					'sisa_akhir': [95, 99, 107, 112, 105, 110, 102, 98, 97, 67, 51, 0]
				};
				return defaultData[key] || new Array(12).fill(0);
			}
			const seriMasuk = makeSeries(tMasuk, 'diterima').slice(0, 11);
			const seriSelesai = makeSeries(tSelesai, 'jumlah_laju_6_13').slice(0, 11);
			const seriSisa = makeSeries(tSisa, 'sisa_akhir').slice(0, 11);
