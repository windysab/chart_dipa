...
<head>
	...
	<style>
		...
		.header img {
			width: 1000px;
			/* Adjusted the width to make the logo larger */
			height: auto;
			margin-bottom: 10px;
		}
		...
		.header h5 {
			font-size: 2rem;
			/* Adjusted the font size to make the title larger */
			font-weight: bold;
		}
...
<body class="hold-transition sidebar-mini layout-fixed">
	<div class="wrapper"> <!-- Navbar --> <?php $this->load->view('template/new_header'); ?> <!-- /.navbar --> <!-- Main Sidebar Container --> <?php $this->load->view('template/new_sidebar'); ?> <!-- Content Wrapper. Contains page content -->
		<div class="content-wrapper"> <!-- Content Header (Page header) -->
			...
			<section class="content">
				<div class="container-fluid"> <!-- Data Perkara Section --> <?php $total_perkara = $perkaraData->total_perkara;
					...
					<div class="row"> <?php foreach ($links as $id => $link): ?> <div class="col-md-4">
								<div class="video-link">
									<h6 class="center-text" id="<?= $id ?>"><?= ucfirst(str_replace('_', ' ', $id)) ?></h6> <iframe id="video-frame-<?= $id ?>" src="<?= $link ?>" allowfullscreen></iframe>
								</div>
					...
					<div class="row">
						<div class="col-lg-6 col-12">
							<div class="card">
								...
								<div class="card-body"> <canvas id="perkaraChart"></canvas> </div>
							</div>
						</div>
					</div>
		...
		</div> <!-- /.content-wrapper --> <!-- Footer --> <?php $this->load->view('template/new_footer'); ?> <!-- /.footer -->
	</div> <!-- ./wrapper --> <!-- jQuery -->
	<script src="<?php echo base_url() ?>assets/plugins/jquery/jquery.min.js"></script> <!-- Bootstrap 4 -->
	<script src="<?php echo base_url() ?>assets/plugins/bootstrap/js/bootstrap.bundle.min.js"></script> <!-- AdminLTE App -->
