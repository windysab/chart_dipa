...
<head>
    ...
    <title><?= htmlspecialchars($title ?? 'Laporan Perkara LIPA – Desember 2025'); ?></title>
...
<body>
    <div class="container-xxl py-4">
        ...
        <div class="hero p-4 mb-4 d-flex justify-content-between align-items-center">
            <div>
                <h3 class="mb-1 fw-bold">LAPORAN PERKARA LIPA DESEMBER</h3>
                <div class="opacity-75">Statistik Perkara Akhir Tahun 2025</div>
            </div>
            <div class="d-flex flex-column align-items-end">
                <span class="badge bg-light text-dark px-3 py-2 rounded-pill mb-2">Desember 2025</span>
                <span class="year-end-indicator">📊 Penutupan Tahun</span>
            </div>
        </div>
        ...
        <div class="row g-3 mb-4">
            <div class="col-md-6">
                <div class="card section-card h-100">
                    <div class="card-body chart-box">
                        <h6 class="mb-3"><i class="fas fa-chart-pie"></i> Distribusi Perkara Desember</h6>
            ...
            <div class="col-md-6">
                <div class="card section-card h-100">
                    <div class="card-body chart-box">
                        <h6 class="mb-3"><i class="fas fa-chart-bar"></i> Tren Penyelesaian Perkara Tahun 2025</h6>
        ...
        <div class="card section-card mb-5">
            <div class="card-body chart-box">
                <h6 class="mb-3"><i class="fas fa-chart-line"></i> Perbandingan Bulanan 2025: Masuk vs Selesai vs Sisa</h6>
            ...
            <div class="col-12">
                <div class="catatan-card">
                    <h6 class="mb-3 text-center" style="color: var(--primary-color); font-weight: 700;">
                        <i class="fas fa-info-circle"></i> CATATAN PERKARA DESEMBER 2025
                    </h6>
                    <div class="row">
                        <div class="col-md-6">
                            <p><strong>Catatan:</strong> Isbat Nikah Kontensius sebanyak 2 perkara (674, 692)</p>
                            <p><strong>Total Perkara 2025:</strong> 1.367 perkara masuk, 1.386 perkara selesai</p>
                        </div>
                        <div class="col-md-6">
                            <p><strong>Efisiensi Penyelesaian:</strong> 101.4% (melebihi target)</p>
                            <p><strong>Sisa Akhir Tahun:</strong> 28 perkara dari total 1.367 yang masuk di tahun 2025</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // ===== BAR: Tren penyelesaian (Tahun 2025) – seri dari controller
            ...
            function makeSeries(src, key) {
                ...
                // Default data with complete year 2025 progression
                const defaultData = {
                    'diterima': [89, 112, 95, 103, 128, 124, 143, 116, 107, 99, 105, 36],
                    'jumlah_laju_6_13': [94, 108, 87, 98, 135, 119, 151, 148, 108, 129, 125, 59],
                    'sisa_akhir': [95, 99, 107, 112, 105, 110, 102, 98, 97, 67, 47, 28]
                };
