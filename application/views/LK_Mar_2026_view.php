	...
	<div class="container">
			...
			<table class="custom-table">
				...
				<tbody>
					<tr>
						...
						<td class="amount-col">Rp 8.702.000</td>
						<td></td>
					</tr>
					<tr>
						<td class="number-col">2</td>
						<td><strong>Penerimaan bulan ini</strong></td>
						<td class="amount-col">Rp 13.157.500</td>
						<td></td>
					</tr>
					<tr>
						...
						<td></td>
						<td class="expense-col">Rp 5.875.000</td>
					</tr>
					<tr>
						<td class="number-col">4</td>
						<td>Biaya Panggilan</td>
						<td></td>
						<td class="expense-col">Rp 1.029.000</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td></td>
						<td class="expense-col">Rp 342.500</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>Materai</td>
						<td></td>
						<td class="expense-col">Rp 720.000</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td></td>
						<td class="expense-col">Rp 1.410.000</td>
					</tr>
					<tr>
						<td></td>
					...
					<tr>
						...
						<td>PNBP lainnya</td>
						<td></td>
						<td class="expense-col">Rp 1.250.000</td>
					</tr>
					<tr>
						<td class="number-col">13</td>
						<td>Pengembalian Sisa Panjar</td>
						<td></td>
						<td class="expense-col">Rp 4.858.000</td>
					</tr>
					<tr class="total-row">
						<td></td>
						<td><strong>Jumlah</strong></td>
						<td><strong>Rp 21.859.500</strong></td>
						<td><strong>Rp 16.404.500</strong></td>
					</tr>
					<tr class="saldo-section">
						<td></td>
						<td><strong>Saldo Akhir</strong></td>
						<td></td>
						<td><strong>Rp 5.455.000</strong></td>
					</tr>
					<tr class="saldo-section">
						<td></td>
						<td><strong>Saldo Bank</strong></td>
						<td></td>
						<td><strong>Rp 3.551.000</strong></td>
					</tr>
					<tr class="saldo-section">
						<td></td>
						<td><strong>Saldo Kas Tunai</strong></td>
						<td></td>
						<td><strong>Rp 1.904.000</strong></td>
					</tr>
				</tbody>
			</table>
		</div>
		...
		<div class="info-section">
			<div class="catatan">
				...
				<ul>
					<li><strong>Perkara masuk:</strong> 95 perkara (9 Prodeo) - Periode musim semi</li>
					<li><strong>Perkara putus:</strong> 61 Perkara (7 Prodeo) - Target penyelesaian stabil</li>
