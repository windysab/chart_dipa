    ...
    <div class="container">
            ...
            <table class="custom-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="amount-cell">21.145.000</td>
                        <td class="amount-cell empty-cell">-</td>
                    </tr>
                    <tr>
                        <td>3</td>
                        ...
                        <td class="amount-cell empty-cell">-</td>
                        <td class="amount-cell">8.000.000</td>
                    </tr>
                    <tr>
                        <td>4</td>
                        <td class="icon-cell"><i class="fas fa-phone"></i>Biaya Panggilan</td>
                        <td class="amount-cell empty-cell">-</td>
                        <td class="amount-cell">1.822.500</td>
                    </tr>
                    <tr>
                        <td>5</td>
                    ...
                    <tr>
                        ...
                        <td class="amount-cell empty-cell">-</td>
                        <td class="amount-cell">770.000</td>
                    </tr>
                    <tr>
                        <td>7</td>
                    ...
                    <tr>
                        ...
                        <td class="amount-cell empty-cell">-</td>
                        <td class="amount-cell">570.000</td>
                    </tr>
                    <tr>
                        <td>12</td>
                    ...
                    <tr>
                        ...
                        <td class="amount-cell empty-cell">-</td>
                        <td class="amount-cell">2.400.000</td>
                    </tr>
                    <tr>
                        <td></td>
                    ...
                    <tr class="saldo-row">
                        ...
                        <td class="amount-cell empty-cell">-</td>
                        <td class="amount-cell">5.869.000</td>
                    </tr>
                </tbody>
            </table>
        </div>
        ...
        <div class="signature-section">
            <div class="info-box">
                ...
                <p><i class="fas fa-file-alt"></i> Perkara masuk: 80 perkara</p>
                <p><i class="fas fa-gavel"></i> Perkara putus: 57 Perkara</p>
            </div>

            <div class="info-box signature-box">
                <h4><i class="fas fa-pen-fancy"></i> Pengesahan</h4>
                <p>Amuntai, 02 Mei 2025</p>
                <div style="display: flex; justify-content: space-around;">
                    <div>
                        <p>Ketua,</p>
                        <div class="signature-line"></div>
                        <p><strong>Bahrul Maji, S.H.I.</strong></p>
                    </div>
                    <div>
                        <p>Panitera,</p>
                        <div class="signature-line"></div>
