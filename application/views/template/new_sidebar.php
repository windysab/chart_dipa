	...
	<div class="sidebar">
		...
		<nav class="mt-2">
			<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
				...
				<li class="nav-item">
					<a href="<?php echo site_url('AgendaSatkerOktoberController') ?>" class="nav-link">
						<i class="nav-icon fas fa-calendar-alt"></i>
						<p>
							Agenda Satker Bulan Oktober
						</p>
					</a>
				</li>
				<li class="nav-item">
					<a href="<?php echo site_url('AgendaSatkerNovemberController') ?>" class="nav-link">
						<i class="nav-icon fas fa-calendar-check"></i>
						<p>
							Agenda Satker Bulan November
						</p>
					</a>
				</li>
				<li class="nav-item">
				...
				<li class="nav-item">
					<a href="<?php echo site_url('LKOktoberPerkaraController') ?>" class="nav-link">
						<i class="nav-icon fas fa-file-invoice-dollar"></i>
						<p>
							Laporan Keuangan Perkara Oktober
						</p>
					</a>
				</li>
				<li class="nav-item">
					<a href="<?php echo site_url('LKNovemberPerkaraController') ?>" class="nav-link">
						<i class="nav-icon fas fa-file-invoice-dollar"></i>
						<p>
							Laporan Keuangan Perkara November
						</p>
					</a>
				</li>
				<li class="nav-item">
				...
				<li class="nav-item">
					<a href="<?php echo site_url('LipaSeptemberController') ?>" class="nav-link">
						...
						<p>
							Laporan Perkara LIPA September
						</p>
					</a>
				</li>
				<li class="nav-item">
				...
				<li class="nav-item">
					<a href="<?php echo site_url('LipaNovemberController') ?>" class="nav-link">
						<i class="nav-icon fas fa-chart-line"></i>
						<p>
							Laporan Perkara LIPA November
						</p>
					</a>
				</li>
				<li class="nav-item">
					<a href="<?php echo site_url('LipaDesemberController') ?>" class="nav-link">
						<i class="nav-icon fas fa-chart-line"></i>
						<p>
							Laporan Perkara LIPA Desember
						</p>
					</a>
				</li>
				<li class="nav-item">
				...
				<li class="nav-item">
					<a href="<?php echo site_url('AgendaPimpinanAgusController') ?>" class="nav-link">
						<i class="nav-icon fas fa-user-tie"></i>
						<p>
							Agenda Pimpinan Agustus
						</p>
					</a>
				</li>
				<li class="nav-item">
					<a href="<?php echo site_url('AgendaPimpinanSeptemberController') ?>" class="nav-link">
						<i class="nav-icon fas fa-user-tie"></i>
						<p>
							Agenda Pimpinan September
						</p>
					</a>
				</li>
				<li class="nav-item">
				...
				<li class="nav-item">
					<a href="<?php echo site_url('AgendaNovemberController') ?>" class="nav-link">
						<i class="nav-icon fas fa-calendar-alt"></i>
						<p>
							Agenda Pimpinan November
						</p>
					</a>
				</li>
				<li class="nav-item">
				...
				<li class="nav-item">
					<a href="<?php echo site_url('LipaMar2026Controller') ?>" class="nav-link">
						<i class="nav-icon fas fa-leaf"></i>
						<p>
							Laporan Perkara LIPA Maret 2026
						</p>
					</a>
				</li>
				...
				<li class="nav-item">
					<a href="<?php echo site_url('LKFeb2026Controller') ?>" class="nav-link">
						<i class="nav-icon fas fa-heart-circle-bolt"></i>
						<p>
