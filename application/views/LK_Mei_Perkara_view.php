...
<head>
    ...
    <title>Laporan Keuangan Perkara - Mei 2025</title>
    ...
    <style>
        :root {
            ...
            --border-radius: 12px;
            --header-gradient: linear-gradient(135deg, #673ab7, #9c27b0);
        }
    ...
    <div class="container">
        ...
        <div class="summary-grid">
            <div class="summary-card">
                ...
                <div class="amount">Rp 38.137.000</div>
                <div class="trend">
                    <i class="fas fa-arrow-up"></i> 5.8% dari bulan lalu
                </div>
            </div>
            <div class="summary-card">
                <div class="summary-card-icon">
                ...
                <div class="amount">Rp 25.939.000</div>
                <div class="trend">
                    <i class="fas fa-arrow-up"></i> 10.2% dari bulan lalu
                </div>
            </div>
            <div class="summary-card">
                <div class="summary-card-icon">
                ...
                <h3>Saldo Akhir</h3>
                <div class="amount">Rp 12.198.000</div>
                <div class="trend negative">
                    <i class="fas fa-arrow-down"></i> 2.3% dari bulan lalu
                </div>
            </div>
            <div class="summary-card">
                <div class="summary-card-icon">
                ...
                <div class="trend">
                    <i class="fas fa-arrow-up"></i> 18.2% dari bulan lalu
                </div>
            </div>
        </div>
        ...
        <div class="financial-table-container">
            <h3 class="table-title">
                <i class="fas fa-table"></i> Laporan Keuangan Perkara Mei 2025
            </h3>
        ...
        <div class="footer-section">
            <div class="stats-card">
                ...
                <ul class="stats-list">
                    <li><i class="fas fa-file-alt"></i> Perkara Masuk: 110 perkara</li>
                    <li><i class="fas fa-balance-scale-right"></i> Perkara Masuk Banding: 2 perkara</li>
                    <li><i class="fas fa-gavel"></i> Perkara Putus: 99 perkara</li>
                    <li><i class="fas fa-calculator"></i> Rasio Penyelesaian: 90%</li>
                </ul>
            </div>
            <div class="signature-card">
                <h4>Pengesahan</h4>
                <div class="signature-date">Amuntai, 02 Juni 2025</div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const financeChart = new Chart(financeCtx, {
                ...
                data: {
                    ...
                    datasets: [{
                            label: 'Penerimaan',
                            data: [31500000, 33200000, 32800000, 36000000, 38137000],
                        ...
                        {
                            label: 'Pengeluaran',
                            data: [22800000, 24500000, 23400000, 23500000, 25939000],
            ...
            const expenseChart = new Chart(expenseCtx, {
                ...
                data: {
                    ...
                    datasets: [{
                        data: [11000000, 2198500, 537000, 990000, 7120000, 4093500],
                        backgroundColor: [
                            '#673AB7',
                            '#9C27B0',
                            '#3F51B5',
