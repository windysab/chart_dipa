...
<head>
    ...
    <title>Laporan Keuangan Perkara - Juli 2025</title>
    ...
    <div class="container">
        ...
        <div class="summary-grid">
            <div class="summary-card">
                ...
                <div class="amount">Rp 50.505.500</div>
                <div class="trend"><i class="fas fa-arrow-up"></i> 36.8% dari bulan lalu</div>
            </div>
            <div class="summary-card">
                <div class="summary-card-icon"><i class="fas fa-hand-holding-usd"></i></div>
                <h3>Total Pengeluaran</h3>
                <div class="amount">Rp 36.420.500</div>
                <div class="trend"><i class="fas fa-arrow-up"></i> 53.8% dari bulan lalu</div>
            </div>
            <div class="summary-card">
                <div class="summary-card-icon"><i class="fas fa-balance-scale"></i></div>
                <h3>Saldo Akhir</h3>
                <div class="amount">Rp 14.085.000</div>
                <div class="trend"><i class="fas fa-arrow-up"></i> 6.4% dari bulan lalu</div>
            </div>
            <div class="summary-card">
                <div class="summary-card-icon"><i class="fas fa-file-invoice"></i></div>
                <h3>Perkara Masuk</h3>
                <div class="amount">146</div>
                <div class="trend"><i class="fas fa-arrow-up"></i> +78% dari bulan lalu</div>
            </div>
        </div>
        <div class="financial-table-container">
            <h3 class="table-title"><i class="fas fa-table"></i> Laporan Keuangan Perkara Juli 2025</h3>
            <div class="table-responsive">
                <table class="financial-table">
                    ...
                    <tbody>
                        <tr><td>1</td><td>Sisa Awal</td><td>13.233.000</td><td class="empty-cell">-</td></tr>
                        <tr><td>2</td><td>Penerimaan bulan ini</td><td>37.272.500</td><td class="empty-cell">-</td></tr>
                        <tr><td>3</td><td>Biaya Proses/ATK/Pemberkasan *)</td><td class="empty-cell">-</td><td>14.400.000</td></tr>
                        <tr><td>4</td><td>Biaya Panggilan</td><td class="empty-cell">-</td><td>2.661.000</td></tr>
                        <tr><td>5</td><td>Biaya Penterjemah</td><td class="empty-cell">-</td><td class="empty-cell">-</td></tr>
                        <tr><td>6</td><td>Biaya Pemberitahuan</td><td class="empty-cell">-</td><td>1.348.000</td></tr>
                        <tr><td>7</td><td>Biaya Sita</td><td class="empty-cell">-</td><td class="empty-cell">-</td></tr>
                        <tr><td>8</td><td>Biaya Pemeriksaan Setempat</td><td class="empty-cell">-</td><td>1.350.000</td></tr>
                        <tr><td>9</td><td>Biaya Sumpah</td><td class="empty-cell">-</td><td class="empty-cell">-</td></tr>
                        <tr><td>10</td><td>Biaya Pengiriman</td><td class="empty-cell">-</td><td class="empty-cell">-</td></tr>
                        <tr><td>11</td><td>Materai</td><td class="empty-cell">-</td><td>1.010.000</td></tr>
                        <tr><td>12</td><td>PNBP</td><td class="empty-cell">-</td><td class="empty-cell">-</td></tr>
                        <tr><td></td><td>Biaya Pendaftaran Tk I</td><td class="empty-cell">-</td><td>4.320.000</td></tr>
                        <tr><td></td><td>Biaya Pendaftaran Banding</td><td class="empty-cell">-</td><td class="empty-cell">-</td></tr>
                        <tr><td></td><td>Biaya Pendaftaran Kasasi</td><td class="empty-cell">-</td><td>50.000</td></tr>
                        <tr><td></td><td>Redaksi</td><td class="empty-cell">-</td><td>1.010.000</td></tr>
                        <tr><td></td><td>PNBP lainnya</td><td class="empty-cell">-</td><td>3.530.000</td></tr>
                        <tr><td>13</td><td>Pengembalian Sisa Panjar</td><td class="empty-cell">-</td><td>6.741.500</td></tr>
                        <tr class="total-row"><td></td><td>Jumlah</td><td>50.505.500</td><td>36.420.500</td></tr>
                        <tr class="saldo-row"><td></td><td>Saldo Akhir</td><td class="empty-cell">-</td><td>14.085.000</td></tr>
                        <tr class="saldo-row"><td></td><td>Saldo Bank</td><td class="empty-cell">-</td><td>3.882.000</td></tr>
                        <tr class="saldo-row"><td></td><td>Saldo Kas Tunai</td><td class="empty-cell">-</td><td>10.203.000</td></tr>
                    </tbody>
                </table>
            </div>
        </div>
        ...
        <div class="footer-section">
            <div class="stats-card">
                ...
                <ul class="stats-list">
                    <li><i class="fas fa-file-alt"></i> Perkara Masuk: 146 perkara (2 perkara prodeo)</li>
                    <li><i class="fas fa-balance-scale-right"></i> Perkara Masuk Kasasi: 1 perkara</li>
                    <li><i class="fas fa-gavel"></i> Perkara Putus: 102 perkara (1 perkara prodeo)</li>
                </ul>
            </div>
            <div class="signature-card">
                <h4>Pengesahan</h4>
                <div class="signature-date">Amuntai, 01 Agustus 2025</div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const expenseChart = new Chart(expenseCtx, {
                ...
                data: {
                    ...
                    datasets: [{
                        data: [14400000, 2661000, 1348000, 1350000, 1010000, 4320000, 50000, 1010000, 3530000, 6741500],
                        backgroundColor: [
                            '#388e3c', '#43a047', '#81c784', '#ffb300', '#ff6f00', '#8d6e63', '#6d4c41', '#bdbdbd', '#cfd8dc', '#e0e0e0'
                        ],
                        borderWidth: 1,
                        hoverOffset: 15
                    }]
